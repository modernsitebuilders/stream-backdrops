...
function findUndefinedHref() {
  ...
  allFiles.forEach(filePath => {
    ...
    try {
      ...
      const patterns = [
        { name: 'href="#"', regex: /href=\{undefined\}/g },
        { name: 'href="#"', regex: /href=\{\}/g },
        { name: 'href="#"', regex: /href="#"/g },
        { name: "href="#"", regex: /href="#"/g },
        { name: 'href="#" where someVar might be undefined', regex: /href=\{[^}]+\}/g },
        { name: 'Link without href', regex: /<Link href="#"(?![^>]*href)[^>]*>/g },
      ...
      patterns.forEach(({ name, regex }) => {
        ...
        if (matches) {
          // For href="#", let's check what that variable might be
