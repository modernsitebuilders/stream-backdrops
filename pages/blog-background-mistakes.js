            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                ...
                <div className="border-l-4 border-red-500 pl-4 bg-red-50 p-4 rounded-r-lg">
                  <h2 className="text-2xl font-bold text-red-900 mb-3">1. Using Distracting or Inappropriate Backgrounds</h2>
                ...
                {/* Mistake 2 */}
                <div className="border-l-4 border-red-500 pl-4 bg-red-50 p-4 rounded-r-lg">
                  <h2 className="text-2xl font-bold text-red-900 mb-3">2. Poor Edge Detection ("Halo Effect")</h2>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h3 className="font-semibold text-red-800 mb-2">The Problem:</h3>
                      <p className="text-red-700">
                ...
                {/* Mistake 3 */}
                <div className="border-l-4 border-red-500 pl-4 bg-red-50 p-4 rounded-r-lg">
                  <h2 className="text-2xl font-bold text-red-900 mb-3">3. Ignoring System Requirements</h2>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h3 className="font-semibold text-red-800 mb-2">The Problem:</h3>
                      <p className="text-red-700">
                ...
                <div className="bg-blue-50 rounded-lg p-6 mt-8">
                  <h2 className="text-2xl font-bold text-blue-900 mb-6">Quick Fix Checklist</h2>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <h3 className="font-semibold text-blue-800 mb-3">Technical Setup</h3>
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-800 mb-3">Professional Appearance</h3>
                      <ul className="list-disc pl-6 text-blue-700 space-y-2">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-800 mb-3">Meeting Preparation</h3>
                      <ul className="list-disc pl-6 text-blue-700 space-y-2">
                ...
                <div className="bg-green-50 rounded-lg p-6 mt-8">
                  ...
                  <Link href="/" className="bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors inline-block mt-4">
